...
data ErrorQualityMetrics = ErrorQualityMetrics
  { -- | 0.0-1.0: How clear is the error message
    errorClarity :: !Double,
    -- | 0.0-1.0: How complete is context info
    contextCompleteness :: !Double,
    -- | 0.0-1.0: How actionable are suggestions
    actionability :: !Double,
    -- | 0.0-1.0: Format consistency score
    consistency :: !Double,
    -- | 0.0-1.0: Severity level accuracy
    severityAccuracy :: !Double
  }
  deriving (Eq, Show)
