...
main = do
  ...
  case parse source "test" of
    Right ast -> do
      ...
      putStrLn $ "preserveTopLevel: " ++ show (opts1 ^. preserveTopLevel)
      putStrLn $ "aggressiveShaking: " ++ show (opts1 ^. aggressiveShaking)
      ...
      let opts2 = defaultOptions & preserveTopLevel .~ False
      putStrLn $ "preserveTopLevel: " ++ show (opts2 ^. preserveTopLevel)
      putStrLn $ "aggressiveShaking: " ++ show (opts2 ^. aggressiveShaking)
