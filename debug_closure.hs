...
main = do
  ...
  case parse source "test" of
    Right ast -> do
      ...
      putStrLn "\n=== IDENTIFIER CHECK ==="
      putStrLn $ "Contains 'captured': " ++ show (astContainsIdentifier optimized "captured")
      putStrLn $ "Contains 'outer': " ++ show (astContainsIdentifier optimized "outer")
...
expressionContainsIdentifier identifier expr = case expr of
  ...
  JSFunctionExpression _ _ _ _ _ body ->
